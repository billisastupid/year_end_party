...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { content: @prize.content, quantity: @prize.quantity, title: @prize.title } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { content: @prize.content, quantity: @prize.quantity, title: @prize.title } }
